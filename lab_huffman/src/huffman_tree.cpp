                            ...
                            queue<TreeNode*>& mergeQueue)
{
     ...
     */
    TreeNode* removeNode;
    if (singleQueue.empty() && mergeQueue.empty()) { //do not have to worry about this
        removeNode = NULL;
    } else if (singleQueue.empty()) {
        removeNode = mergeQueue.front();
        mergeQueue.pop();
    } else if (mergeQueue.empty()) {
        removeNode = singleQueue.front();
        singleQueue.pop();
